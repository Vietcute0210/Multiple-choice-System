...
// Ham getStudentUsers: thuc hien get student users.
function getStudentUsers() {
  return getUsers().filter((user) => user.role === 'student');
}

// Ham calcMetrics: thuc hien calc metrics.
...
// Ham renderOverview: thuc hien render overview.
...
// Ham renderStudentDetail: thuc hien render student detail.
...
// Ham openResultDetail: thuc hien open result detail.
