...
// Ham makeEmptyQuestion: thuc hien make empty question.
...
// Ham renderQuestions: thuc hien render questions.
...
// Ham fillExamForm: thuc hien fill exam form.
...
// Ham normalizeQuestionIds: thuc hien normalize question ids.
function normalizeQuestionIds() {
  questions = questions.map((question, idx) => ({ ...question, id: idx + 1 }));
}

// Ham addQuestion: thuc hien add question.
...
// Ham removeQuestion: thuc hien remove question.
...
// Ham importDemoQuestion: thuc hien import demo question.
...
// Ham validateQuestions: thuc hien validate questions.
...
// Ham saveExam: thuc hien save exam.
function saveExam() {
...
// Ham bindEditorEvents: thuc hien bind editor events.
