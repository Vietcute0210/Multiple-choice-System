...
import { openModal, closeModal, showToast, showConfirm } from '../core/ui.js';
...
// Ham calcUserStats: thuc hien calc user stats.
...
// Ham openUserModal: thuc hien open user modal.
...
// Ham saveUser: thuc hien save user.
...
// Ham deleteUser: thuc hien delete user.

function deleteUser(userId) {

  showConfirm('Xác nhận x?a sinh vi?n n?y?', {
    ...
    onConfirm: () => {
      ...
      showToast('?? x?a sinh vi?n v? d? li?u li?n quan.', 'success');
